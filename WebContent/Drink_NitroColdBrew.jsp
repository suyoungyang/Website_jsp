...
<!-- 파일 Drinkfrom.js:폼의 각 입력값이 있는지를 검토하는 함수 구현 -->
...
<!-- return -->
<div id="return">
	<a href="http://localhost:8090/JSPWebEx04/Drink.jsp">← 이전화면</a>
</div>
...
<div id="content">
	<table id="table_style" >
			<tr>
				<td rowspan="4" align="center" width="480px"><img src="image/음료/나이트로 콜드브루.PNG" alt="나이트로 콜드브루"></td>
				<td class="text_big" align="center">나이트로 콜드브루</td>
			</tr>
			<tr><td align="center"><input type=hidden name="name" value="<%=name="나이트로콜드브루"%>">Nitro Cold Brew</td></tr>	
			<tr><td align="center"><input type=hidden name="price" value="<%=price=5800%>">5,800 원</td></tr>
			...
			<tr height="80px"><td class="alert" align="center" colspan="2" width="960px" style="text-size:1px;">픽업대로 오시면 음료를 제조해드립니다.<br>매장 찾기에서 나이트로 콜드 브루 판매매장을 확인해보세요.<br>
			...
			<input type=hidden name="syrup" value="<%=syrup="해당없음"%>"><input type=hidden name="milk" value="<%=milk="해당없음"%>"><input name="topping" type=hidden value="<%=topping="해당없음"%>">
			<tr height="30px"><td align="center">컵&리드 옵션(0 원)</td><td align="center"><select name="lid" style="width:150px; height:30px;"><option selected value="<%=lid="리드"%>">리드</option><option value="<%=lid="리드덮어서제공"%>">리드 덮어서 제공</option></select></td></tr>
			<!-- 버튼을 누르면 drinkform.js의 함수를 실행하여 processdrink.jsp로 이동한다. -->
			<tr height="50px"><td align="center" colspan="2"><input type=submit class="table_button" value="담기" onClick="drinkcheck()"></td></tr>
		</table>
	</div>
...
<footer id="main_footer">
	...
	<div>
		<h3>비슷한 다른 메뉴</h3>
		<table>
			<tr><td><img src="image/음료/나이트로 쇼콜라.PNG" width="150px" height="150px"></td><td><a href="http://localhost:8090/JSPWebEx04/Drink_NitroChocolateCloud.jsp"><img src="image/음료/나이트로 쇼콜라클라우드.PNG" width="150px" height="150px"></a></td>
			...
			<tr height="40px"><td class="footer-text"  width="130px" height="20px">나이트로 쇼콜라</td><td class="footer-text"  width="130px" height="20px">나이트로 <br>쇼콜라클라우드</td><td class="footer-text" width="130px" height="20px">돌체 콜드브루</td><td class="footer-text" width="130px" height="20px">바닐라 크림<br>콜드브루</td>
